...
class IncomeListCardMonth extends StatefulWidget {
  @override
  _IncomeListCardMonthState createState() => _IncomeListCardMonthState();
}

class _IncomeListCardMonthState extends State<IncomeListCardMonth> {
  final MyIncomeController myIncomeController = Get.find<MyIncomeController>();
  @override
  void initState() {
    print('my icome for month');
      ...
      () {
        if (myIncomeController.isLoading.value) {
          ...
          return RefreshIndicator(
            ...
            onRefresh: () => myIncomeController.fetchMyIncomeMonth(),
            child: ListView.separated(
              separatorBuilder: (context, index) => index.remainder(3) == 1
                  ...
                  : SizedBox(height: 12),
              itemCount: myIncomeController.myIncomeMonthList[0].orders.length,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            'Id ' +
                                myIncomeController
                                    .myIncomeMonthList[0].orders[index].id
                                    .toString(),
                            style: FontStyles.boldStyle(
                              fontSize: 16,
                              fontFamily: 'Montserrat',
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            myIncomeController.myIncomeMonthList[0]
