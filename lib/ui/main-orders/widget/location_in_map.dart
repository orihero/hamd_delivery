...
class _MapViewState extends State<MapView> {
  ...
  _getAddress() async {
    try {
      List<g.Placemark> p = await g.placemarkFromCoordinates(
          _currentPosition.latitude, _currentPosition.longitude);

      g.Placemark place = p[0];
  ...
  Future<bool> _calculateDistance() async {
    try {
      ...
      List<g.Location> startPlacemark =
          await g.locationFromAddress(_startAddress);
      List<g.Location> destinationPlacemark =
          await g.locationFromAddress(_destinationAddress);
  ...
  _createPolylines(Position start, Position destination) async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      "AIzaSyA9lIVEXUvvgivZuVMEasMU_ejHYsdYmHg", // Google Maps API Key
...
//   GoogleMapController mapController;
//   double _originLatitude = 41.28558777446754, _originLongitude = 69.2585628;
//   double _destLatitude = 41.291456625027884, _destLongitude = 69.26465677848373;
...
//         apiKey: "AIzaSyA9lIVEXUvvgivZuVMEasMU_ejHYsdYmHg",
//         firstPoint: MapPoint(41.28558777446754, 69.2585628),
//         secondPoint: MapPoint(41.391456625027884, 69.36465677848373),
